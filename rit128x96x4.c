...
{
  unsigned char defaultcolor = 15;
	unsigned long linenum;
	unsigned long defaultcolumn = 0;
	char buf[19];
	char both[19];
	char empty[19]={' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',0};
  ...
  strcat(both, buf);
	...
	RIT128x96x4StringDraw(empty, defaultcolumn, linenum, defaultcolor); //Clears line for overwriting
  RIT128x96x4StringDraw(both, defaultcolumn, linenum, defaultcolor);
